...
import com.openjad.common.exception.IllegalArgumentException;
...
public class AssertUtil {
	...
	/**
	 * Assert a boolean expression, throwing an {@code AssertFailException}
	 * if the expression evaluates to {@code false}.
	 * <p>Call {@link #isTrue} if you wish to throw an {@code ArgumentValidateException}
