...
import com.openjad.common.util.reflection.ClassHelper;
...
//            }
	...
	public static Object getFieldValue(final Object obj, final String fieldName) {
		...
		if (field == null) {
			throw new ReflectionException(UtilLogCode.CODE_00004, "在目标对象[" + obj + "]中找不到属性 [" + fieldName + "] ");
		}
		...
		try {
			...
			logger.error(UtilLogCode.CODE_00010, "不可能抛出的异常," + e.getMessage(), e);
		}
		return result;
	}
	...
	public static void setFieldValue(final Object obj, final String fieldName, final Object value) {
		...
		if (field == null) {
			throw new ReflectionException(UtilLogCode.CODE_00004,
					"找不到属性 [" + fieldName + "] 目标类型:[" + obj.getClass().getName() + "]");
		}

		if (value != null) {
			if (!field.getType().isAssignableFrom(value.getClass())) {
				throw new ReflectionException(UtilLogCode.CODE_00006,
	...
	public static Object invokeMethod(final Object obj, final String methodName,
		...
		if (method == null) {
			throw new ReflectionException(UtilLogCode.CODE_00005, "在目标对象[" + obj + "]中找不到方法 [" + methodName + "]");
		}
		try {
			return method.invoke(obj, args);
		} catch (Exception e) {
			throw new ReflectionException(UtilLogCode.CODE_00010, e);
		}
	}
	...
	public static Method findGetterMethod(Class containerClass, String propertyName) {
		...
		if (getter == null) {
			...
			throw new ReflectionException(UtilLogCode.CODE_00007, err);
		}
	...
	public static <T> T createInstance(Class<T> clazz, Object... params) {
		try {
			...
			if (constructors.length == 0) {
				throw new ReflectionException(UtilLogCode.CODE_00005, "没有找到构造方法," + clazz.getName());
			}
			...
			throw new ReflectionException(UtilLogCode.CODE_00005, "没有找到构造方法");
		} catch (Throwable t) {
			throw new ReflectionException(UtilLogCode.CODE_00010, "通过返射实例化对象失败," + t.getMessage(), t);
		}
