 ...
 */
public class ListBySelectCriteriaSP extends MapperItemSP {

	public ListBySelectCriteriaSP(MapperSP mapperSP) {
		super(mapperSP, "select", "listBySelectCriteria");
	}
	...
	public Node toNode() {
		...
		node.setAttribute("parameterType", CRITERION_PACKAGE + ".SelectCriteria");
